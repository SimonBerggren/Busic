...
* 
* Translated into TypeScript by:
* @author SimonBerggren / https://github.com/SimonBerggren
*/
...
class TransformControlsPlane extends THREE.Mesh {
    constructor() {
        super(new THREE.PlaneBufferGeometry(100000, 100000, 2, 2), new THREE.MeshBasicMaterial({ visible: false, wireframe: true, side: THREE.DoubleSide, transparent: true, opacity: 0.1 }))
